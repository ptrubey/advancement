...
One metric by which we might identify and declare atmospheric rivers is the integrated water vapor
  transport, or \emph{IVT} \bruno{Why does `` emph '' produce an underlying word instead of italics? It messes up the style of the references}\makenote{I don't know.  It doesn't when I build it on my computer.  This is only happening in overleaf...}.  This value represents the total amount of water vapor being transported
