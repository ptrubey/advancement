...
\bruno{I would create a new section. The introduction stays as such, with the stuff you have in the first two paragraphs. The I would add a decsirption of the three projects: EVT, anomaly detection and application with computational developments. The I would add a roadmap to the document, like: in the next section we review ..., in Section XX we consider ..., ... .}
...
To motivate the topic and our proposed solution, we acknowledge the relevance of extreme analysis to
  ...
  events.\makenote{add glue}~\citep{jentsch2007,vousdoukas2018,li2019}  To this end, we use the
  integrated water vapor transport data for observing atmospheric rivers as a test case for our methodology.

\subsection{Background - Atmospheric Rivers}

\bruno{Sections 1.1 - 1.4 become the new section ``Background''}
