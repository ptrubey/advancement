...
For model comparison, as the projection induces its own distortion, we will
  conduct model comparison in $S_{\infty}^{d-1}$, using a scoring rule appropriate
  to that space.

\input{methodology_dirichlet}

\input{methodology_projgamma}

\input{methodology_gendirichlet}
% \input{methodology_projmixgamma}
%
% \input{methodology_mixprojgamma}
%
% \input{methodology_npmpg}

% \input{methodology_prior}
%
\input{methodology_probit}
%
% \input{methodology_dppglognormal}
