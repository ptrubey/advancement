...
\bruno{
  The three models that you consider in this section are essentially the same model with three
  variations. You should write the section by presenting a model that consists of a mixture of
  Dirichlet with two options: a finite mixture and a DP mixture, the a submodel for the DP
  misture where you consider two choices fot he hyperparameter priors. Now, is it really worth
  presenting all three different models?
  }
% EOF
